...
from sentence_transformers.losses.TripletLoss import TripletDistanceMetric # TripletDistanceMetric 직접 임포트
...
MODEL_NAME = "stella-lora-us-add-triplet"
REPO = "LUcowork"
...
# 3. 데이터셋 로드
dataset = load_dataset(f"{REPO}/stage1-add-triplet")
